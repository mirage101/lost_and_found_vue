    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="appNavbar">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item">
            <router-link to="/lost" class="nav-link" aria-current="page">
              Report Lost
            </router-link>
          </li>
          <li class="nav-item">
            <router-link to="/found" class="nav-link" aria-current="page">
              Report Found
            </router-link>
          </li>
          <li class="nav-item">
            <router-link to="/advices" class="nav-link" aria-current="page">
              Advices
            </router-link>
          </li>
          <li class="nav-item">
            <router-link to="/vets" class="nav-link" aria-current="page">
              Nearby vets
            </router-link>
          </li>
          <li class="nav-item">
            <router-link to="/mission" class="nav-link" aria-current="page">
              Mission
            </router-link>
          </li>
