...
async function register(req, res) {
  ...
  const { username, email, first_name, last_name, password, password_confirm, admin } = req.body;
  ...
  try {
    ...
    await User.create({ email, username, password: hashedPassword, first_name, last_name, admin });
